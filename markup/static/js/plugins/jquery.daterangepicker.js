        ...
        function createMonthHTML(d) {
            ...
            for (var week = 0; week < 6; week++) {
                ...
                for (var day = 0; day < 7; day++) {
                    ...
                    var nextDay = days[week * 7 + _day + 1];
                    var prevDay = days[week * 7 + _day - 1];
                    ...
                    if ( nextDay.type == 'nextMonth' && today.type !== 'nextMonth') {
                      classLast = 'lastDayInMonth'
                    } else if ( prevDay.type == 'lastMonth' && today.type !== 'lastMonth') {
                      classLast = 'firstDayInMonth'
                    }

                    var todayDivAttr = {
                        time: today.time,
                        'data-tooltip': today.tooltip,
                        'class': 'day ' + (classLast ? classLast : '') + ' ' + today.type + ' ' + today.extraClass + ' ' + (today.valid ? 'valid' : 'invalid') + ' ' + (highlightToday ? 'real-today' : '')
                    };
                    ...
                    html.push('<td ' + attributesCallbacks({}, opt.dayTdAttrs, today) + '><div ' + attributesCallbacks(todayDivAttr, opt.dayDivAttrs, today) + '><span class="day__digit">' + showDayHTML(today.time, today.day) + '</span></div></td>');
                }
                html.push('</tr>');
            }
            return html.join('');
